    ...
    <header className="h-20 glass-panel flex items-center justify-between px-4 lg:px-12 z-30 sticky top-0 border-b border-white/5">
      <div className="flex items-center gap-8">
        ...
        <nav className="hidden lg:flex items-center gap-1 bg-white/5 p-1 rounded-2xl border border-white/5">
          <Link href="/" className="px-6 py-2 rounded-xl text-sm font-bold bg-white/10 text-white shadow-sm">
            Portal
          </Link>
          <Link href="/search" className="px-6 py-2 rounded-xl text-sm font-bold text-zinc-500 hover:text-zinc-200 hover:bg-white/5 transition-all">
            Búsqueda
          </Link>
          <Link href="/history" className="px-6 py-2 rounded-xl text-sm font-bold text-zinc-500 hover:text-zinc-200 hover:bg-white/5 transition-all">
            Historial
          </Link>
        </nav>
      </div>
