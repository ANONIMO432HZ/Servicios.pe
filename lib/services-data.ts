...
export interface ServiceLink {
  ...
  logoPath: string; // Relative path to /ASSETS/
...
export const SERVICES: ServiceLink[] = [
  // CATEGORIA: NACIONAL
  {
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/sunarp_consulta_vehicular.png',
    status: 'Operativo'
  },
  {
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/sunarp_dueños_deudas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-multas-lima',
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/sat_multas.png',
    status: 'Operativo'
  },
  {
  ...
  },
  {
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/sutran_multas.png',
    status: 'Operativo'
  },
  {
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/sutran__multas_verificacion.png',
    status: 'Operativo'
  },
  {
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/revision_tecnica.png',
    status: 'Operativo'
  },
  {
    id: 'atu-multas',
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/atu_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-capturas-rq',
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/sat_rq_infracciones.png',
    status: 'Operativo'
  },
  {
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/sigueloPlus_seguimiento_titulos.png',
    status: 'Operativo'
  },
  {
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/pnp_lunas_polarisadas.png',
    status: 'Operativo'
  },
  {
    id: 'mtc-licencias',
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/mtc_consulta_licencias.png',
    status: 'Operativo'
  },
  {
    id: 'sunarp-tive',
  ...
  },
  {
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/rq_vehicular.png',
    status: 'Operativo'
  },
  {
    ...
    category: 'Nacional',
    logoPath: '/ASSETS/pit_fotopapeletas.png',
    status: 'Operativo'
  },
  {
    id: 'fise-taller-gnv',
  ...
  // CATEGORIA: REGIONAL
  {
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_piura_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-chiclayo',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_chiclayo_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-tacna',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_tacna_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-chachapoyas',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_chachapoyas_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-ica',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_ica_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-andahuaylas',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_andahuaylas_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-huancayo',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_huancayo_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-arequipa',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_arequipa_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-cajamarca',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_cajamarca_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-trujillo',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_trujillo_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-tarapoto',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_tarapoto_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-huanuco',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_huanuco_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-pucallpa',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_pucallpa.png',
    status: 'Operativo'
  },
  {
    id: 'sat-cusco',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/sat_cusco_multas.png',
    status: 'Operativo'
  },
  {
    id: 'sat-callao',
    ...
    category: 'Regional',
    logoPath: '/ASSETS/muni_callao_multas.png',
    status: 'Operativo'
  },
  ...
  // CATEGORIA: SEGUROS
  {
    ...
    category: 'Seguros',
    logoPath: '/ASSETS/sbs_choques_siniestros.png',
    status: 'Operativo'
  },
  {
    id: 'apeseg-soat',
    ...
    category: 'Seguros',
    logoPath: '/ASSETS/soat_consulta.png',
    status: 'Operativo'
  },
  {
    id: 'soat-vigencia',
  ...
  // CATEGORIA: OTROS
  {
    ...
    category: 'Otros',
    logoPath: '/ASSETS/aap_cambio_placa.png',
    status: 'Operativo'
  },
  {
    id: 'infogas-deuda',
    ...
    category: 'Otros',
    logoPath: '/ASSETS/infogas_deuda_placa.png',
    status: 'Operativo'
  },
  {
    id: 'aap-oficinas',
    ...
    category: 'Otros',
    logoPath: '/ASSETS/aap_asociacion_automotriz_del_peru.png',
    status: 'Operativo'
  }
];
