    ...
    <aside className={`fixed inset-y-0 left-0 z-40 w-64 glass-panel transform transition-transform duration-300 ease-in-out flex flex-col ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 md:static md:flex-shrink-0`}>
      <div className="h-16 flex items-center px-6 border-b border-white/10">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-bold text-white tracking-tight">Servicios<span className="text-primary">.pe</span></h2>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-white/10">
        ...
        <button 
          ...
          className="flex items-center w-full px-4 py-3 rounded-xl text-zinc-500 hover:bg-red-500/10 hover:text-red-500 transition-all font-medium"
        >
